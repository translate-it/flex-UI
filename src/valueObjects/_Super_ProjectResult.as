 ...
 * of this value object you may modify the generated sub-class of this class - ProjectResult.as.
 */
...
[ExcludeClass]
public class _Super_ProjectResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.Project.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ProjectResultEntityMetadata;
     ...
     * properties
     */
    private var _internal_project : valueObjects.Project;
    ...
    public function _Super_ProjectResult()
    {
        _model = new _ProjectResultEntityMetadata(this);
    ...
    public function get project() : valueObjects.Project
    {
    ...
    public function set project(value:valueObjects.Project) : void
    {
        var oldValue:valueObjects.Project = _internal_project;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ProjectResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ProjectResultEntityMetadata) : void
    {
        var oldValue : _ProjectResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfProject : valueObjects.Project;

    model_internal function _doValidationForProject(valueIn:Object):Array
    {
        var value : valueObjects.Project = valueIn as valueObjects.Project;
