...
internal class _UsersEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("admin", "countries", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "password", "googleAccount");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("admin", "countries", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "password", "googleAccount");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("admin", "countries", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "password", "googleAccount");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("admin", "countries", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "password", "googleAccount");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("admin", "countries", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "password", "googleAccount");
    ...
    public function _UsersEntityMetadata(value : _Super_Users)
    {
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of Users");
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity Users");
        }
