...
public class _Super_Projects extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
     ...
     * properties
     */
    private var _internal_project : ArrayCollection;
    model_internal var _internal_project_leaf:valueObjects.Project;
    ...
    public function get project() : ArrayCollection
    {
    ...
    public function set project(value:*) : void
    {
        var oldValue:ArrayCollection = _internal_project;
        if (oldValue !== value)
        {
            ...
            {
                _internal_project = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_project = null;
            }
            else
            {
                throw new Error("value of project must be a collection");
            }
    ...
    model_internal function setterListenerProject(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerProject);
            }
        }
    ...
    model_internal var _doValidationLastValOfProject : ArrayCollection;
