 ...
 * of this value object you may modify the generated sub-class of this class - Identity.as.
 */
...
[ExcludeClass]
public class _Super_Identity extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _IdentityEntityMetadata;
    ...
    private var _internal_projects : String;
    ...
    public function _Super_Identity()
    {
        _model = new _IdentityEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "projects", model_internal::setterListenerProjects));
    ...
    [Bindable(event="propertyChange")]
    public function get projects() : String
    {
    ...
    public function set projects(value:String) : void
    {
        var oldValue:String = _internal_projects;
        if (oldValue !== value)
        {
            _internal_projects = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "projects", oldValue, _internal_projects));
        }
    }
    ...
    model_internal function setterListenerProjects(value:flash.events.Event):void
    {
        _model.invalidateDependentOnProjects();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.projectsIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_projectsValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _IdentityEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _IdentityEntityMetadata) : void
    {
        var oldValue : _IdentityEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfProjects : Array = null;
    model_internal var _doValidationLastValOfProjects : String;

    model_internal function _doValidationForProjects(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfProjects != null && model_internal::_doValidationLastValOfProjects == value)
           return model_internal::_doValidationCacheOfProjects ;

        _model.model_internal::_projectsIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isProjectsAvailable && _internal_projects == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "projects is required"));
        }

        model_internal::_doValidationCacheOfProjects = validationFailures;
        model_internal::_doValidationLastValOfProjects = value;
