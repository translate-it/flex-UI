 ...
 * of this value object you may modify the generated sub-class of this class - BundleResult.as.
 */
...
[ExcludeClass]
public class _Super_BundleResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _BundleResultEntityMetadata;
     ...
     * properties
     */
    private var _internal_bundle : valueObjects.Bundle;
    ...
    public function _Super_BundleResult()
    {
        _model = new _BundleResultEntityMetadata(this);
    ...
    public function get bundle() : valueObjects.Bundle
    {
    ...
    public function set bundle(value:valueObjects.Bundle) : void
    {
        var oldValue:valueObjects.Bundle = _internal_bundle;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _BundleResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _BundleResultEntityMetadata) : void
    {
        var oldValue : _BundleResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfBundle : valueObjects.Bundle;

    model_internal function _doValidationForBundle(valueIn:Object):Array
    {
        var value : valueObjects.Bundle = valueIn as valueObjects.Bundle;
