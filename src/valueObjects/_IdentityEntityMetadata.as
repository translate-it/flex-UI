...
[ExcludeClass]
internal class _IdentityEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("password", "projects", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "googleAccount");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("password", "projects", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "googleAccount");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("password", "projects", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "googleAccount");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("password", "projects", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "googleAccount");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("password", "projects", "lastName", "languages", "enabled", "username", "email", "bundles", "role", "firstName", "googleAccount");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Identity";
    ...
    model_internal var _projectsIsValid:Boolean;
    model_internal var _projectsValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _projectsIsValidCacheInitialized:Boolean = false;
    model_internal var _projectsValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Identity;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _IdentityEntityMetadata(value : _Super_Identity)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["projects"] = new Array();
        ...
        model_internal::propertyTypeMap["projects"] = "String";
        ...
        model_internal::_projectsValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForProjects);
        model_internal::_projectsValidator.required = true;
        model_internal::_projectsValidator.requiredFieldError = "projects is required";
        //model_internal::_projectsValidator.source = model_internal::_instance;
        //model_internal::_projectsValidator.property = "projects";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Identity");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Identity");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of Identity");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity Identity");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity Identity");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isProjectsAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnProjects():void
    {
        if (model_internal::_projectsIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfProjects = null;
            model_internal::calculateProjectsIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get projectsStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get projectsValidator() : StyleValidator
    {
        return model_internal::_projectsValidator;
    }

    model_internal function set _projectsIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_projectsIsValid;         
        if (oldValue !== value)
        {
            model_internal::_projectsIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "projectsIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get projectsIsValid():Boolean
    {
        if (!model_internal::_projectsIsValidCacheInitialized)
        {
            model_internal::calculateProjectsIsValid();
        ...
        return model_internal::_projectsIsValid;
    }

    model_internal function calculateProjectsIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_projectsValidator.validate(model_internal::_instance.projects)
        model_internal::_projectsIsValid_der = (valRes.results == null);
        model_internal::_projectsIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::projectsValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::projectsValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get projectsValidationFailureMessages():Array
    {
        if (model_internal::_projectsValidationFailureMessages == null)
            model_internal::calculateProjectsIsValid();

        return _projectsValidationFailureMessages;
    }

    model_internal function set projectsValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_projectsValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_projectsValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "projectsValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("projects"):
            {
                return projectsValidationFailureMessages;
            }
            case("lastName"):
            {
