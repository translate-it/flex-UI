 ...
 * of this value object you may modify the generated sub-class of this class - Bundle.as.
 */
...
[ExcludeClass]
public class _Super_Bundle extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _BundleEntityMetadata;
    ...
    private var _internal_defaultBundle : Boolean;
    private var _internal_description : String;
    private var _internal_name : String;
    private var _internal_global : Boolean;
    ...
    public function _Super_Bundle()
    {
        _model = new _BundleEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get defaultBundle() : Boolean
    {
        return _internal_defaultBundle;
    }
    ...
    public function set defaultBundle(value:Boolean) : void
    {
        var oldValue:Boolean = _internal_defaultBundle;
        if (oldValue !== value)
        {
            _internal_defaultBundle = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "defaultBundle", oldValue, _internal_defaultBundle));
        }
    }
    ...
    {
        var oldValue:Boolean = _internal_global;
        if (oldValue !== value)
        {
            _internal_global = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "global", oldValue, _internal_global));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _BundleEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _BundleEntityMetadata) : void
    {
        var oldValue : _BundleEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
