 ...
 * of this value object you may modify the generated sub-class of this class - ListUsersResult.as.
 */
...
[ExcludeClass]
public class _Super_ListUsersResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.Users.initRemoteClassAliasSingleChild();
        valueObjects.User.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ListUsersResultEntityMetadata;
    ...
    model_internal var _internal_users_leaf:valueObjects.Users;
    ...
    public function _Super_ListUsersResult()
    {
        _model = new _ListUsersResultEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ListUsersResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ListUsersResultEntityMetadata) : void
    {
        var oldValue : _ListUsersResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
